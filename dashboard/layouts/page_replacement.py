...
def replacement_page_body():
                        ...
                        [
                            ...
                            html.P(
                                [
                                    ...
                                    " is estimated remaining accounting value after monthly ",
                                    "straight-line depreciation (down to 5% salvage).",
                                ],
    ...
    life_panel = html.Div(
        [
            ...
            html.Label("Extra months", style=_field_label),
            dcc.Input(
                id="replace-life-extra-months",
                type="number",
                min=0,
                max=240,
                step=1,
            ...
            html.Span(
                "Added on top of the system-estimated useful life in whole months (0 clears the override).",
                style=_field_hint,
            ),
