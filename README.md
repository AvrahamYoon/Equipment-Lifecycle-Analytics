...
- **Settings** — Mostly Overview-only; staff capacity can be overridden per calendar month. Click **Apply** to save to `data/settings/app_settings.json` on the server (shared for all users). **Reset** restores defaults.
